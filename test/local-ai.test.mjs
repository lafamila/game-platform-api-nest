...
test('server save slots cannot continue matched games until the original match finishes', async () => {
  ...
  assert.equal(continued.session.players.white, '__game_platform_local_ai__');
  ...
  assert.equal(crazyContinued.session.players.opponent, '__game_platform_local_ai__');
