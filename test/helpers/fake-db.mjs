  ...
  async query(sql, args = []) {
    if (sql.includes('INSERT INTO ai_decisions')) {
      const row = {
        ...
        budget_ms: args[8],
        elapsed_ms: args[9],
        completed_depth: args[10],
        search_nodes: args[11],
        vcf_nodes: args[12],
        vct_nodes: args[13],
        evaluation_calls: args[14],
        forbidden_checks: args[15],
        candidate_generations: args[16],
        score: args[17],
        principal_variation_json: JSON.parse(args[18]),
        exit_reason: args[19],
        decision_source: args[20],
        fallback_reason: args[21],
      };
